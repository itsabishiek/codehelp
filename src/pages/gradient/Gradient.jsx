...
const Gradient = () => {
  const [colorOne, setColorOne] = useState("#00ccff");
  const [colorTwo, setColorTwo] = useState("#da10ae");
  ...
  return (
    <div
      className="gradient"
      style={{
        backgroundImage: `linear-gradient(to ${direction}, ${colorOne}, ${colorTwo})`,
      }}
    >
      <div className="gradient-container">
        ...
        >
          <p style={{ fontSize: 14, padding: 4 }}>Three color gradient</p>
        </Link>
      </div>
    </div>
  );
